...
function renderRoutesToLiquiditySlide(){
  ...
  <div class="fig-text" data-fig-name="tldr-0" style="position:absolute;left:68.00px;top:200.00px;width:1554.00px;height:52.00px;font-family:'Plus Jakarta Sans',sans-serif;font-weight:400;font-style:normal;font-size:19.00px;line-height:24.00px;letter-spacing:0.00px;color:#808582;text-align:left;white-space:pre-wrap;overflow-wrap:break-word;">PSERS’ short and long-term objectives will determine the asset perimeter, buyer universe and transaction structure. Options listed below are not mutually exclusive and can be aligned with PSERS’ return and timing expectations.</div>
