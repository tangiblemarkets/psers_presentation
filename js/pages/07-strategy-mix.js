...
function renderStrategyMixSlide(){
  ...
  <div class="fig-text smVintageTitle smHintTitle" data-fig-name="t" data-action="portfolioSummary" role="button" tabindex="0" title="Open portfolio source data" style="position:absolute;left:74.00px;top:244.00px;width:420.00px;height:18.00px;font-family:'Plus Jakarta Sans',sans-serif;font-weight:600;font-style:normal;font-size:15.00px;line-height:17.24px;letter-spacing:1.03px;color:#787878;text-align:left;white-space:nowrap;cursor:pointer;">SHARE OF NAV BY STRATEGY<span class="kcSummaryHint">&gt; Click data to expand</span></div>
  ...
  ${commentaryCards}
  <div class="fig-text smVintageTitle smHintTitle smHintTitle--wrap" data-fig-name="SHARE OF NAV BY VINTAGE" data-action="vintageView" role="button" tabindex="0" title="Open vintage profile (all vintages)" aria-label="Open vintage profile (all vintages)" style="position:absolute;left:74.00px;top:618.00px;width:280.00px;height:40.00px;font-family:'Plus Jakarta Sans',sans-serif;font-weight:600;font-style:normal;font-size:15.00px;line-height:18.90px;letter-spacing:0.00px;color:#787878;text-align:left;cursor:pointer;">SHARE OF NAV BY VINTAGE<span class="kcSummaryHint">&gt; Click data to expand</span></div>
