...
function renderStrategyMixSlide(){
  ...
  <div class="fig-text" data-fig-name="title" style="position:absolute;left:68.00px;top:126.00px;width:1550.00px;height:58.00px;font-family:'Plus Jakarta Sans',sans-serif;font-weight:500;font-style:normal;font-size:46.00px;line-height:57.96px;letter-spacing:0.00px;color:#104130;text-align:left;white-space:pre;">A balanced portfolio across strategies and vintages</div>
  <div class="fig-text" data-fig-name="t" style="position:absolute;left:74.00px;top:244.00px;width:300.00px;height:18.00px;font-family:'Plus Jakarta Sans',sans-serif;font-weight:600;font-style:normal;font-size:15.00px;line-height:17.24px;letter-spacing:1.03px;color:#787878;text-align:left;white-space:pre;">SHARE OF NAV BY STRATEGY</div>
